  ...
  return (
    <div>
      ...
      <Paragraph size={"small"}>
        ...
        dignissim massa. Integer ultricies erat ac urna commodo iaculis. Quisque
        a nunc feugiat, vehicula nisl nec, blandit quam. Sed eu sagittis nulla.
        Suspendisse in quam placerat, rutrum nunc id, vestibulum augue. Cras
        congue tempor gravida. Fusce nec ligula sit amet lorem cursus fermentum
        vitae id massa. Nunc tempor ipsum et dictum pretium. Vivamus pretium
        varius ex vel consequat. Vestibulum
      </Paragraph>
      ...
      <Paragraph size={"xlarge"}>
        ...
        Suspendisse in quam placerat, rutrum nunc id, vestibulum augue. Cras
        congue tempor gravida. Fusce nec ligula sit amet lorem cursus fermentum
        vitae id massa. Nunc tempor ipsum et
      </Paragraph>
      ...
      <Box wrap={true} direction={"row-responsive"}>
        ...
        <Box direction={"column"} pad={"medium"}>
          ...
          <Box direction={"row-responsive"}>
            ...
            <Box background={"status-warning"} margin={"xsmall"} pad={"small"}>
              <Text>status-warning</Text>
            </Box>
            <Box background={"status-unknown"} margin={"xsmall"} pad={"small"}>
              <Text>status-unknown</Text>
            </Box>
            <Box background={"status-disabled"} margin={"xsmall"} pad={"small"}>
